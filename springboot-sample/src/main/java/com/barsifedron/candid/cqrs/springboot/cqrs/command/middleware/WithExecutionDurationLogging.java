package com.barsifedron.candid.cqrs.springboot.cqrs.command.middleware;
...
public class WithExecutionDurationLogging implements CommandBusMiddleware {
    ...
    private final static Logger LOGGER = Logger.getLogger(
            com.barsifedron.candid.cqrs.command.middleware.WithExecutionDurationLogging.class.getName());
